...
# READ: https://github.com/cubxxw/k8s-demo/tree/main/scripts/install/environment.sh 
...
if [[ $? -ne 0 ]]; then
  ...
  echo "+++ https://github.com/cubxxw/k8s-demo/tree/main/scripts/install/environment.sh +++"
else
