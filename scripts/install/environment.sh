...
# Read: https://github.com/cubxxw/k8s-demo/blob/main/docs/contrib/init_config.md
# 格式化 bash 注释：https://tool.lu/shell/
# 配置中心文档：https://github.com/cubxxw/k8s-demo/blob/main/docs/contrib/environment.md
...
###################### openim 配置 ######################
# read: https://github.com/cubxxw/k8s-demo/blob/main/deployment/init/README.md
