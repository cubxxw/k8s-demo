...
# Usage Instructions: https://github.com/cubxxw/k8s-demo/tree/main/docs/contrib/git_cherry-pick.md
...
if [[ "$#" -lt 2 ]]; then
  ...
  echo
  echo "  For merge process info, see https://github.com/cubxxw/k8s-demo/tree/main/docs/contrib/git_cherry-pick.md"
  exit 2
fi
...
For details on the cherry pick process, see the [cherry pick requests](https://github.com/cubxxw/k8s-demo/tree/main/docs/contrib/git_cherry-pick.md) page.
