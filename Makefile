...
ROOT_PACKAGE=github.com/cubxxw/k8s-demo
# TODO: This is version control for the future https://github.com/cubxxw/k8s-demo/issues/574
VERSION_PACKAGE=github.com/cubxxw/k8s-demo
